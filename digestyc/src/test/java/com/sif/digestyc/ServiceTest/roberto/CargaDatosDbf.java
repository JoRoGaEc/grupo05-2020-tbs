...
@SpringBootTest
public class CargaDatosDbf {

	private static final Logger LOG = LoggerFactory.getLogger(CargaDatosDbf.class);

	@Autowired
	private CargaDbfController cargaDbfController;
	...
	public void insercionDatos() {
		String ubicacion = "C://directorio2/books.dbf";
		Formato formato  = new Formato();
		formato.setId(1L);
		
		Directorio directorio  = new Directorio();
		directorio.setId(1L);
		//cargaDbfController.crearMetadataDeTablaDbf(3L, "TABLA2",formato, ubicacion);
		//cargaDbfController.crearMetadataDeTablaDbf(3L, "TABLA2",formato, directorio, ubicacion);
