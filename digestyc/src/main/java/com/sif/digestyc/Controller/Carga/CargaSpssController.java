...
public class CargaSpssController extends ConexionSqlServer{
	...
	public Map<String, String> crearMetadataDeTablaSpss(Long idRegistro, Long idEntrega, String nombreTabla, Formato formato,
			String ubicacion) {
		...
		if (entrega.getVersionPlantilla() == null) {
			boolean plantillaValida = archivoSpss.validarColumnasSpss(ubicacion, entrega.getRegistro());
			if (plantillaValida == true || entrega.getVersionPlantilla() != null) {
				...
				datos = archivoSpss.leerDatosSpssParaInsercion(pColumnas, ubicacion, entrega.getRegistro());
				if (tablaDb != null) {
	...
	public List<String> crearColumnasOrigen(Tabla tabla, String ubicacion) {
		...
		List<String> columnasString = archivoSpss.leerColumnasSpssDelServidor(ubicacion); // Recuperar las columnas del
																							// archivo
	...
	public List<String> crearColumnasOrigen(List<PlantillaColumna> pColumnas, Tabla tabla, String ubicacion) {
		...
		List<String> columnasString = archivoSpss.leerColumnasSpssDelServidor(ubicacion);// Esto para crear una
